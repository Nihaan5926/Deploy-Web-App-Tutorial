...
app.post('/api/logs', (req, res) => {
  ...
  const stmt = db.prepare(`
    INSERT INTO logs (date, ssps, sas, g1_region, ses, cis, iiu, dau, total1, g2_region, male_area, si, ci, ct, cni, total2)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  `);
  const info = stmt.run(date, d.ssps, d.sas, d.g1_region, d.ses, d.cis, d.iiu, d.dau, d.total1, d.g2_region, d.male_area, d.si, d.ci, d.ct, d.cni, d.total2);
...
app.put('/api/logs/:id', (req, res) => {
  ...
  const stmt = db.prepare(`
    ...
    WHERE id = ?
  `);
  stmt.run(d.ssps, d.sas, d.g1_region, d.ses, d.cis, d.iiu, d.dau, d.total1, d.g2_region, d.male_area, d.si, d.ci, d.ct, d.cni, d.total2, req.params.id);
